            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="card">
                     ...
                     <?php if ($this->session->flashdata('deletesub_success')) { ?>
                        <p id="success-message" style="color:green"><?php echo $this->session->flashdata('deletesub_success'); ?></p>
                     <?php } ?>
                                 ...
                                 ?>
                                       <tbody>
                                          <tr>
                                             ...
                                             <td><?php echo anchor("sub_admin/Category/subdelete/{$row->id}", 'Delete'); ?></td>
                                          </tr>
                                       <?php
                                       $cnt = $cnt + 1;
                                    endforeach;
