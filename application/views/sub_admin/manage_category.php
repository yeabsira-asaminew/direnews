         ...
         <div class="container-fluid">
            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="card">
                     <!--success message -->
                     <?php if ($this->session->flashdata('deletecat_success')) { ?>
                        <p id="success-message" style="color:green"><?php echo $this->session->flashdata('deletecat_success'); ?></p>
                     <?php } ?>
                                 ...
                                 ?>
                                       <tbody>
                                          <tr>
                                             ...
                                             <td><?php echo anchor("sub_admin/Category/delete/{$row->id}", 'Delete'); ?></td>
                                          </tr>
                                       <?php
                                       $cnt = $cnt + 1;
                                    endforeach;
