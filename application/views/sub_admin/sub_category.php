         ...
         <div class="container-fluid">
            ...
            <div class="row">
               ...
               <div class="col-lg-6 inline-forms">
                  <div class="card">
                     <!--success message -->
                     <?php if ($this->session->flashdata('addsub_success')) { ?>
                        <p id="success-message" style="color:green"><?php echo $this->session->flashdata('addsub_success'); ?></p>
                     <?php } ?>

                     <!-- error message -->
                     <?php if ($this->session->flashdata('addsub_error')) { ?>
                        <p id="error-message" style="color:red"><?php echo $this->session->flashdata('addsub_error'); ?></p>
                     <?php } ?>

                     <div class="card-block">
                        <?php echo form_open('sub_admin/Category/subcategory', ['name' => 'create']); ?>
                        <div class="row">
