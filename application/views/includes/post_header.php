                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <!--  <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="languageDropdown">
                            <li><a class="dropdown-item" href="<?php echo site_url("Contact_us/switchLang/english"); ?>">English</a></li>
                            <li><a class="dropdown-item" href="<?php echo site_url("Contact_us/switchLang/amharic"); ?>">አማርኛ</a></li>
                            <li><a class="dropdown-item" href="<?php echo site_url("Contact_us/switchLang/oromo"); ?>">Afaan Oromoo</a></li>
                            <li><a class="dropdown-item" href="<?php echo site_url("Contact_us/switchLang/somali"); ?>">Af Somali</a></li>
                        </ul>
                    </li>
            -->
                </ul>
