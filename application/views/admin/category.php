...
<head>
   <title>Dire News | Category</title>
         ...
         <div class="container-fluid">
            ...
            <div class="row">
               ...
               <div class="col-lg-6 inline-forms">
                  <div class="card">
                     <?php if ($this->session->flashdata('addcat_success')) { ?>
                        <p id="success-message" style="color:green"><?php echo $this->session->flashdata('addcat_success'); ?></p>
                     <?php } ?>

                     <!-- error message -->
                     <?php if ($this->session->flashdata('addcat_error')) { ?>
                        <p id="error-message" style="color:red"><?php echo $this->session->flashdata('addcat_error'); ?></p>
                     <?php } ?>
