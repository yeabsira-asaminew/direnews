...
<head>
   <title> Dire News Portal | Profile</title>
                     ...
                     <div class="card-block">
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-6 form-group">
                              ...
                              <?php echo form_input(['name' => 'name', 'id' => 'name', 'class' => 'form-control', 'placeholder' => 'Enter your User Name', 'value' => set_value('fromdate', $profile->name)]); ?>
