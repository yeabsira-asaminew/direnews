                     ...
                     <div class="card-block">
                        <div class="row">
                           <div class="col-sm-12 table-responsive">
                              <!--success message -->
                              <?php if ($this->session->flashdata('deletenews_success')) { ?>
                                 <p id="success-message" style="color:green"><?php echo $this->session->flashdata('deletenews_success'); ?></p>
                              <?php } ?>
                                 ...
                                 ?>
                                       <tbody>
                                          <tr>
                                             ...
                                             <td><?php echo anchor("journalist/News/delete/{$row->id}", 'Delete'); ?>
                                                | <?php echo anchor("journalist/News/editdata/{$row->id}", 'Edit'); ?>
