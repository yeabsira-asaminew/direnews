...
<head>
   <title>Dire News Portal | Add Post</title>
         ...
         <div class="container-fluid">
            ...
            <div class="row">
               ...
               <div class="col-lg-12 inline-forms">
                  <div class="card">
                     <!--success message -->
                     <?php if ($this->session->flashdata('addnews_success')) { ?>
                        <p id="success-message" style="color:green"><?php echo $this->session->flashdata('addnews_success'); ?></p>
                     <?php } ?>

                     <!-- error message -->
                     <?php if ($this->session->flashdata('addnews_error')) { ?>
                        <p id="error-message" style="color:red"><?php echo $this->session->flashdata('addnews_error'); ?></p>
                     <?php } ?>

                     <div class="card-block">
                        <?php echo form_open_multipart('journalist/News/add'); ?>
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-6 form-group">
                              ...
                              <input class="form-control" type="file" name="image" id="image" placeholder="AddImage">
                           </div>
...
<script>
   $(document).ready(function() {
      $('#category').change(function() {
         ...
         if (category_name != '') {
            $.ajax({
               url: "<?php echo base_url(); ?>journalist/News/fetch_subcategory",
               method: "POST",
               data: {
